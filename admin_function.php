 ...
 <div style="
            ...
            ">
                <form action="" method="post">
                    <input type="search" class="searchbox" name="searchpatientappoint" id="searchpatient" placeholder="Enter Patient Name" required="">
...
<?
 ...
 <div style="
            ...
            ">
                <form action="" method="post">
                    <input type="search" class="searchbox" name="searchpatient" id="searchpatient" placeholder="Enter Patient name" required="">
    ...
    <tr>
        ...
        <td>
            <form action="remove.php" method="post">
                ...
                <button type="submit" class="cancel">Remove</button></form>
        </td>
        <td>
            <form action="appoinment.php" method="post">
            <input type="hidden" name="pid" value="<?=$pid?>">
            <input type="hidden" name="admin" value="1">
            <button type="submit" class="view_bill"> Add Appointment</button></form>
        </td>
        <td>
            <form action="updateuser.php" method="post">
            <input type="hidden" name="pid" value="<?=$pid?>">
            <button type="submit" class="view_bill">Edit</button></form>
        </td>
    </tr>
    <? }  ?>
</table>
