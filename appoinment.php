...
<body>
    ...
    <div class="showpaneflex book_appointment_main_container">
        ...
        <div class="patienttable book_appointment_second_container">
            <b><h2><center>Appointment has been scheduled Succesfully</center></h2></b><br><br>
        ...
        if($result && $admin < 1) {?>
        <div class="patienttable book_appointment_second_container">
          <b><h2><center>Appointment has been scheduled Succesfully</center></h2></b><br>
        ...
        <form action="" method="post">
            ...
            <div class="bookdata">
                ...
                <div class="bookdataoption">
                    <input type="date" name="appdate" id="appdate" value="<?echo $date;?>" min="<?echo $date;?>" max="<? echo $enddate;?>" required>
                </div>
            </div>
            <div class="bookdata">
                <div class="bookdataheading">
                ...
                <div class="bookdataoption">
                    <input type="time" name="apptime" id="apptime" min="10:00" max="17:00" title="select time between 10am to 5pm" required>
                </div>
            </div>
            <div class="bookdata">
                <div class="bookdataheading">
